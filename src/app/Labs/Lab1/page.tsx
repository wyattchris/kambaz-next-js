...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        <h4>Downloading a coding environment</h4>
        For fall 2025 web-dev, it is recommended that we use VS-Code because it
        interfaces well with our web dev technologies
      </div>
      <h3>Page routing</h3>
      <div id="wd-h-tag">
        <h4>How to create navigation in next JS</h4>
        As an exercise, we created the lab 1 directory to showcase how to create
        navigatable pages in our next js application
      </div>
      <div id="wd-p-tag">
        <h4>Paragraph Tag</h4>
        <p id="wd-p-1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Scramble eggs in pan</li>
          <li>Cook bacon in separate or same pan for extra flavor</li>
          <li>Melt a cheese of your choice on the eggs</li>
          <li>
            Add finished ingredients to a roll for a bacon egg and cheese!
          </li>
        </ol>
      ...
      to get dummy text
      <br />
      To reach my github, <a href='https://github.com/wyattchris' id='wd-github'> click here </a>
    </div>
  );
}
